...
import org.apache.uima.tutorial.SentenceAnnot;


/**
  break the file into sentences
  record the position and content of each sentence
  Sentence: sentence ID (source)+ sentence content
 */
public class SentenceAnnotator extends JCasAnnotator_ImplBase{

  /**
   * receive pJCas: the previous CAS          
   * Step 1. split the text input into sentences
   * Step 2. split the sentence into sourceID and contents
   * Step 3. convert string to CAS
