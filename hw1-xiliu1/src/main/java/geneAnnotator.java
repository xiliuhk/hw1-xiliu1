...
/**
 * break the sentence into word tokens
 * record the position and content of each token
 * record the gene mention and its position
 */

public class geneAnnotator extends JCasAnnotator_ImplBase {
   /**
   * use LingPipe pack
   * receive pJCas: previous CAS 
   * Step 1. feed HMM a sentence to determine if it contains a gene tag
   * Step 2. record the gene tags into words
   * Step 3. convert the gene tags objects to CAS
